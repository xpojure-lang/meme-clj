(ns m2clj-lang.formatter.canon
  "Canonical formatter: width-aware m1clj output.
   ...
   Uses `m2clj-lang.form-shape/registry` as the default form-shape vocabulary;
...
(def style
  "Canonical formatting style — opinions over semantic slot names.
   ...
   The vocabulary of slot names is contracted with `m2clj-lang.form-shape`.
...
(defn format-form
  "Format a single Clojure form as canonical text.
   ...
   Preserves comments only when called on AST nodes (`m2clj-lang.api/m2clj->ast`,
   ...
   opts: {:width 80 :form-shape reg :style s :mode m} or bare integer width.
     ...
     :form-shape  registry (default m2clj-lang.form-shape/registry).  Pass
     ...
     :mode        :m2clj (default) — emit m2clj syntax (bare-paren list literals)
...
(defn format-forms
  "Format a sequence of Clojure forms as canonical text, separated by
   ...
   opts: {:width 80 :mode :m2clj|:clj} or bare integer width."
