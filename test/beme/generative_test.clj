(ns beme.generative-test
  "Property-based generative tests for the beme reader/printer roundtrip.
...
(defspec prop-print-produces-valid-beme 300
  (prop/for-all [form gen-form]
    (try
      (let [printed (p/print-beme-string [form])]
...
(def gen-syntax-quote-beme
  "Generate beme strings containing syntax-quote forms."
...
(def gen-syntax-quote-with-unquote
  "Generate beme strings with syntax-quote containing ~ unquotes."
  (gen/let [name gen-simple-symbol
