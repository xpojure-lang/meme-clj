(ns beme.repl-test
  "Tests for beme.repl input-state logic and read-input multi-line accumulation.
...
#?(:clj (def ^:private input-state beme.repl/input-state))
#?(:clj (def ^:private read-input @#'beme.repl/read-input))
