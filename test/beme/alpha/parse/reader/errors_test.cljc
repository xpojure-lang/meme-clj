(ns beme.alpha.parse.reader.errors-test
...
;; ---------------------------------------------------------------------------
;; ClojureScript-specific: opaque forms give beme-specific error messages
;; ---------------------------------------------------------------------------

#?(:cljs
(deftest cljs-opaque-form-errors
  (testing "reader conditional gives beme-specific error on CLJS"
