(ns beme.alpha.errors-test
  "Unit tests for beme.alpha.errors: format-error display and source-context extraction."
...
(deftest beme-error-basic
  ...
  (testing ":source-context absent when :line missing"
    (let [e (try (errors/beme-error "err" {:col 1 :source "hello"}) nil
                 (catch #?(:clj Exception :cljs :default) e e))]
