(ns meme.tools.repl-test
  "Tests for meme.tools.repl input-state logic and read-input multi-line accumulation.
...
(def ^:private input-state meme.tools.repl/input-state)
